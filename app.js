...
function getVaccineBaseTypeByMap(vaccineId) {
  const map = {
...
function getVaccineDetail(vaccineId) {
  const baseType = getVaccineBaseTypeByMap(vaccineId);
...
if (typeof module !== "undefined") { module.exports = { getVaccineBaseType }; }
