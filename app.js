...
function getVaccineBaseTypeMap(vaccineId) {
  const map = {
...
function getVaccineDetail(vaccineId) {
  const baseType = getVaccineBaseTypeMap(vaccineId);
...
if (typeof module !== "undefined" && module.exports) { module.exports = { S, currentUser }; }
