...
function getVaccineBaseTypeInfo(vaccineId) {
  const map = {
...
function getVaccineDetail(vaccineId) {
  const baseType = getVaccineBaseTypeInfo(vaccineId);
...
if (typeof module !== "undefined" && module.exports) { module.exports = { vaccineStatus }; }
